...
北京时间2023：2：2 苏州担任在职的python开发（外贸网站的后端开发（从0开始）+ 部分前端）+ 自动化爬虫（针对linkedin国际版、noxinfluence、baijing等，）+数据库、运维（aliyun 美国centos），另外需要一个前端小弟，前端能做的好看些，无需工作经验但要真的会（ctrlcv+多学多看多尝试总会吧）。
